        ...
        <div class="flex flex-wrap justify-center gap-8">
            ...
            @if($values->count() > 0)
                @foreach($values as $value)
                    <div
                        class="group p-8 rounded-3xl bg-slate-50 border border-slate-100 transition-all duration-500 hover:bg-white hover:shadow-2xl hover:shadow-indigo-500/10 hover:-translate-y-2 text-center w-full sm:w-[calc(50%-1rem)] lg:w-[calc(33.33%-1.5rem)] xl:w-[calc(20%-1.6rem)]">
                        <div
                            class="w-20 h-20 bg-indigo-50 rounded-2xl flex items-center justify-center text-indigo-600 mb-8 transition-transform duration-500 group-hover:rotate-12 group-hover:scale-110 overflow-hidden border border-indigo-100 mx-auto">
            ...
            @else
                ...
                <div
                    class="group p-8 rounded-3xl bg-slate-50 border border-slate-100 transition-all duration-500 hover:bg-white hover:shadow-2xl hover:shadow-indigo-500/10 hover:-translate-y-2 text-center w-full sm:w-[calc(50%-1rem)] lg:w-[calc(33.33%-1.5rem)]">
                    <div
                        class="w-20 h-20 bg-indigo-100 rounded-2xl flex items-center justify-center text-indigo-600 mb-8 transition-transform duration-500 group-hover:rotate-12 group-hover:scale-110 mx-auto">
                ...
                <div
                    class="group p-8 rounded-3xl bg-slate-50 border border-slate-100 transition-all duration-500 hover:bg-white hover:shadow-2xl hover:shadow-indigo-500/10 hover:-translate-y-2 text-center w-full sm:w-[calc(50%-1rem)] lg:w-[calc(33.33%-1.5rem)]">
                    <div
                        class="w-20 h-20 bg-emerald-100 rounded-2xl flex items-center justify-center text-emerald-600 mb-8 transition-transform duration-500 group-hover:-rotate-12 group-hover:scale-110 mx-auto">
                        <svg class="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div
                    class="group p-8 rounded-3xl bg-slate-50 border border-slate-100 transition-all duration-500 hover:bg-white hover:shadow-2xl hover:shadow-indigo-500/10 hover:-translate-y-2 text-center w-full sm:w-[calc(50%-1rem)] lg:w-[calc(33.33%-1.5rem)]">
                    <div
                        class="w-20 h-20 bg-blue-100 rounded-2xl flex items-center justify-center text-blue-600 mb-8 transition-transform duration-500 group-hover:rotate-12 group-hover:scale-110 mx-auto">
                        <svg class="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
