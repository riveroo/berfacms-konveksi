        ...
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8">
                @foreach($categories as $category)
                    <a href="{{ $category->link }}" class="group relative block aspect-[4/3] rounded-2xl overflow-hidden bg-white shadow-sm hover:shadow-xl transition-all duration-300 flex items-center justify-center p-4">
    ...
    <section class="bg-slate-50 py-16">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8">
                @for ($i = 1; $i <= 3; $i++)
                    <a href="#" class="group relative block aspect-[4/3] rounded-2xl overflow-hidden bg-white shadow-sm hover:shadow-xl transition-all duration-300 flex items-center justify-center p-4">
