                            ...
                            <tr wire:key="row-{{ $index }}" class="hover:bg-gray-50/30 dark:hover:bg-gray-800/10 transition">
                                ...
                                <td class="px-4 py-3">
                                    ...
                                    @else
                                        <select 
                                            ...
                                            wire:change="onMaterialChange({{ $index }})"
                                            class="w-full border-gray-300 dark:border-gray-700 dark:bg-gray-950 rounded-lg shadow-sm focus:border-primary-500 focus:ring-primary-500 text-gray-900 dark:text-white text-sm"
                                            required
                                        >
                                ...
                                <td class="px-4 py-3">
                                    @if ($row['item_type'] === 'product')
                                        <select 
                                            ...
                                            wire:change="onSizeChange({{ $index }})"
                                            class="w-full border-gray-300 dark:border-gray-700 dark:bg-gray-950 rounded-lg shadow-sm focus:border-primary-500 focus:ring-primary-500 text-gray-900 dark:text-white text-sm"
                                ...
                                <td class="px-4 py-3">
                                    <input 
                                        ...
                                        required
                                    >
                                    @if ($row['max_stock'] > 0 || ($row['item_type'] === 'product' && !empty($row['variant_id'])) || ($row['item_type'] === 'material' && !empty($row['item_id'])))
                                        <span class="text-[10px] text-gray-500 dark:text-gray-400 mt-1 block">
                                            Max Available: {{ $row['max_stock'] }}
                                        </span>
                                    @endif
