        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8">
            ...
            <div class="lg:col-span-7 flex flex-col">
                ...
                <div class="flex items-center gap-4 mt-8">
                    <button type="button" @click="addToCart()" id="addToCartBtn"
                        :disabled="!isValidSelection() || isLoading"
                        class="flex-1 max-w-xs bg-indigo-600 hover:bg-indigo-700 text-white font-bold text-sm py-4 rounded-2xl transition-all shadow-xl shadow-indigo-200 active:scale-95 disabled:bg-gray-100 disabled:text-gray-400 disabled:cursor-not-allowed disabled:shadow-none flex items-center justify-center gap-3">
                        ...
                        <span x-text="isValidSelection() ? 'Tambah ke troli' : 'Stok Kosong'"></span>
                    </button>
