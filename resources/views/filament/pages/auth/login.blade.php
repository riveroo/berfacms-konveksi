<div>
    ...
    <div class="flex h-screen w-full font-sans antialiased text-gray-900 bg-white">
        ...
        <div class="hidden lg:flex w-1/2 bg-blue-600 items-center justify-center p-12 relative overflow-hidden">
            <!-- Decorative circles -->
            <div class="absolute -top-24 -left-24 w-96 h-96 bg-blue-500 rounded-full mix-blend-multiply filter blur-2xl opacity-50"></div>
            <div class="absolute -bottom-24 -right-24 w-96 h-96 bg-blue-700 rounded-full mix-blend-multiply filter blur-2xl opacity-50"></div>
            ...
            <div>
                ...
                <x-text variant="body" class="text-blue-100 text-lg mt-4">
        ...
        <div class="w-full flex lg:w-1/2 items-center justify-center px-6 py-12 bg-gray-50">
